        ...
        return this.each(function (index) {
            ...
            var get = {
                city: function(indexProvince){
                    return $.extend([], mapProvince[indexProvince]["city"]);
                },
                county: function(indexProvince, indexCity){
                    return $.extend([], mapProvince[indexProvince]["city"][indexCity]["area"]);
                }
            };

            // 判断占位符
            var provinceHolder = $province.data("placeholder"),
                cityHolder = $city.data("placeholder"),
                countyHolder = $county.data("placeholder");

            var placeholder = {
                hasProHolder: function(){
                    return !!$.trim(provinceHolder);
                },
                hasCityHolder: function(){
                    return !!$.trim(cityHolder);
                },
                hasCountyHolder: function(){
                    return !!$.trim(countyHolder);
                },
                setProHolder: function () {
                    if (this.hasProHolder()){
                        mapProvince.unshift({
                            "name": provinceHolder,
                            "city": [{
                                "name": cityHolder,
                ...
                setCityHolder: function(){
                    var _self = this;
                    if (this.hasCityHolder()){
                        $(mapProvince).each(function (index, provinces) {
                            if(_self.hasProHolder()&& index === 0){
                                return true;
                            }
                            provinces.city.unshift({
                                "name": cityHolder,
                                "area": [countyHolder],
                            })
                        })
                ...
                setCounty: function () {
                    var _self = this;
                    if (this.hasCountyHolder()){
                        $(mapProvince).each(function (index, citys) {
                            $(citys.city).each(function (index, city) {
                                if((_self.hasProHolder() ||_self.hasCityHolder())  && index === 0){
                                    return true;
                                }
                                city.area.unshift(countyHolder);
                            });
                        })
                    }
                },
            ...
            var dist = {
                ...
                createProvince: function (arrProvince) {
                    for(var i = 0, len = arrProvince.length; i < len; ++i) {
                        this.strProvince += this.createOption(arrProvince[i]["name"]);
                    }
                },
                createCity: function(arrCity){
                    this.strCity = "";
                    for(var i = 0, len = arrCity.length; i < len; ++i) {
                        this.strCity += this.createOption(arrCity[i]["name"]);
                    }
                },
                createCounty: function(arrCounty) {
                    this.strCounty = "";
                    for(var i = 0, len = arrCounty.length; i < len; ++i) {
                        this.strCounty += this.createOption(arrCounty[i]);
                    }
                },
                listen: function () {
                    var _self = this;
                    ...
                    $province.on("change", function() {
                        ...
                        var arrCity = get.city(indexProvince),
                            arrCounty = get.county(indexProvince, 0);
                ...
                init: function (province, city, county) {
                    ...
                    province = province || $province.val();
                    city = city || $city.val();
                    county = county || $county.val();
                ...
                start: function () {
                    ...
                    var province = $province.data("value") ,
                        city = $city.data("value"),
                        county = $county.data("value");

                    // 这里的初始值需要按照约定进行，即指定实际输出的地址值
